...
int free_path(image label, double x, double y, double theta, double enemy_x, double enemy_y, double erear_x, double erear_y) {

	ibyte* p;
	int* obs_pixel, n_obspixel, k = 0;

	p = label.pdata;
	//Calculate number of pixels that contain obstacles
	n_obspixel = npixels(label, 5);
